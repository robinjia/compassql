...
},{"./property":11,"./wildcard":29,"vega-lite/src/channel":46}],2:[function(require,module,exports){
"use strict";
/**
...
},{"./encoding":4,"./spec":5}],4:[function(require,module,exports){
"use strict";
...
},{"../property":11,"../propindex":12,"../query/encoding":13,"../schema":26,"../util":28,"../wildcard":29,"./base":2,"vega-lite/src/aggregate":43,"vega-lite/src/channel":46,"vega-lite/src/scale":53,"vega-lite/src/type":57}],5:[function(require,module,exports){
"use strict";
var __extends = (this && this.__extends) || function (d, b) {
    for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p];
    function __() { this.constructor = d; }
...
},{"../property":11,"../propindex":12,"../query/encoding":13,"../util":28,"../wildcard":29,"./base":2,"vega-lite/src/aggregate":43,"vega-lite/src/channel":46,"vega-lite/src/mark":52,"vega-lite/src/scale":53,"vega-lite/src/type":57}],6:[function(require,module,exports){
"use strict";
...
},{"./config":1,"./constraint/constraint":3,"./enumerator":7,"./generate":8,"./model":9,"./nest":10,"./property":11,"./query/query":15,"./ranking/ranking":25,"./schema":26,"./util":28,"./wildcard":29}],7:[function(require,module,exports){
"use strict";
...
},{"./constraint/encoding":4,"./constraint/spec":5,"./property":11,"./propindex":12}],8:[function(require,module,exports){
"use strict";
...
},{"./config":1,"./enumerator":7,"./model":9,"./property":11,"./stylize":27}],9:[function(require,module,exports){
"use strict";
var aggregate_1 = require("vega-lite/src/aggregate");
var type_1 = require("vega-lite/src/type");
var property_1 = require("./property");
...
},{"./property":11,"./query/encoding":13,"./query/groupby":14,"./query/shorthand":16,"./query/spec":17,"./util":28,"./wildcard":29,"./wildcardindex":30,"vega-lite/src/aggregate":43,"vega-lite/src/type":57}],10:[function(require,module,exports){
"use strict";
var channel_1 = require("vega-lite/src/channel");
...
},{"./model":9,"./property":11,"./propindex":12,"./query/groupby":14,"./query/shorthand":16,"./query/spec":17,"datalib/src/util":38,"vega-lite/src/channel":46}],11:[function(require,module,exports){
"use strict";
var util_1 = require("./util");
...
exports.SCALE_CHILD_PROPS = ['clamp', 'domain', 'exponent', 'nice', 'range', 'rangeStep', 'round', 'type', 'useRawDomain', 'zero'];
exports.AXIS_CHILD_PROPS = ['axisColor', 'axisWidth', 'format', 'offset', 'orient', 'shortTimeLabels', 'subdivide', 'values', 'zindex',
...
exports.LEGEND_CHILD_PROPS = ['format', 'orient', 'offset', 'shortTimeLabels', 'values',
...
exports.SCALE_PROPS = exports.SCALE_CHILD_PROPS.map(function (c) {
    return { parent: 'scale', child: c };
});
var AXIS_PROPS = exports.AXIS_CHILD_PROPS.map(function (c) {
    return { parent: 'axis', child: c };
});
var LEGEND_PROPS = exports.LEGEND_CHILD_PROPS.map(function (c) {
...
exports.DEFAULT_PROP_PRECEDENCE = [
    ...
    'scale', 'sort',
    'axis', 'legend'
].concat(BIN_PROPS, exports.SCALE_PROPS, AXIS_PROPS, LEGEND_PROPS);
var Property;
(function (Property) {
    Property.MARK = 'mark';
...
},{"./property":11,"./util":28}],13:[function(require,module,exports){
"use strict";
var type_1 = require("vega-lite/src/type");
...
},{"../util":28,"../wildcard":29,"vega-lite/src/compile/scale/type":47,"vega-lite/src/type":57}],14:[function(require,module,exports){
"use strict";
var util_1 = require("datalib/src/util");
...
},{"../property":11,"../propindex":12,"../util":28,"./shorthand":16,"datalib/src/util":38}],15:[function(require,module,exports){
"use strict";
var config_1 = require("../config");
var generate_1 = require("../generate");
...
},{"../config":1,"../generate":8,"../nest":10,"../ranking/ranking":25,"../util":28,"./encoding":13,"./groupby":14,"./shorthand":16,"./spec":17,"./transform":18}],16:[function(require,module,exports){
"use strict";
var aggregate_1 = require("vega-lite/src/aggregate");
var channel_1 = require("vega-lite/src/channel");
...
function fieldDef(encQ, include, replacer) {
    ...
    if (include.get(property_1.Property.AGGREGATE) && encQ.autoCount === false) {
        return '-';
    }
    var fn = func(encQ, include, replacer);
    var props = fieldDefProps(encQ, include, replacer);
    // field
    var fieldAndParams = include.get('field') ? value(encQ.field || '*', replacer.get('field')) : '...';
    // type
 ...
 */
function func(encQ, include, replacer) {
    if (include.get(property_1.Property.AGGREGATE) && encQ.aggregate && !wildcard_1.isWildcard(encQ.aggregate)) {
        return replace(encQ.aggregate, replacer.get(property_1.Property.AGGREGATE));
    }
    else if (include.get(property_1.Property.AGGREGATE) && encQ.autoCount && !wildcard_1.isWildcard(encQ.autoCount)) {
        // autoCount is considered a part of aggregate
        return replace('count', replacer.get(property_1.Property.AGGREGATE));
        ;
    }
    else if (include.get(property_1.Property.TIMEUNIT) && encQ.timeUnit && !wildcard_1.isWildcard(encQ.timeUnit)) {
        return replace(encQ.timeUnit, replacer.get(property_1.Property.TIMEUNIT));
    }
    else if (include.get(property_1.Property.BIN) && encQ.bin && !wildcard_1.isWildcard(encQ.bin)) {
        return 'bin';
    }
    else {
        var fn = null;
        for (var _i = 0, _a = [property_1.Property.AGGREGATE, property_1.Property.AUTOCOUNT, property_1.Property.TIMEUNIT, property_1.Property.BIN]; _i < _a.length; _i++) {
            var prop = _a[_i];
            var val = encQ[prop];
            if (include.get(prop) && encQ[prop] && wildcard_1.isWildcard(val)) {
...
function fieldDefProps(encQ, include, replacer) {
    ...
    for (var _i = 0, _a = [property_1.Property.SCALE, property_1.Property.SORT, property_1.Property.AXIS, property_1.Property.LEGEND]; _i < _a.length; _i++) {
        var parent_1 = _a[_i];
        if (!wildcard_1.isWildcard(encQ.channel) && !exports.PROPERTY_SUPPORTED_CHANNELS[parent_1][encQ.channel]) {
            continue;
        }
        if (include.get(parent_1) && encQ[parent_1] !== undefined) {
            var parentValue = encQ[parent_1];
...
(function (shorthandParser) {
    ...
    function rawFieldDef(encQ, fieldDefPart) {
        ...
        encQ.type = type_1.getFullName(fieldDefPart[1].toUpperCase()) || '?';
...
},{"../property":11,"../propindex":12,"../util":28,"../wildcard":29,"./spec":17,"datalib/src/util":38,"vega-lite/src/aggregate":43,"vega-lite/src/channel":46,"vega-lite/src/timeunit":56,"vega-lite/src/type":57}],17:[function(require,module,exports){
"use strict";
var channel_1 = require("vega-lite/src/channel");
...
},{"../property":11,"../util":28,"../wildcard":29,"vega-lite/src/channel":46,"vega-lite/src/stack":55}],18:[function(require,module,exports){
"use strict";
...
},{"../query/encoding":13,"../util":28,"vega-lite/src/aggregate":43,"vega-lite/src/type":57}],20:[function(require,module,exports){
"use strict";
var channel_1 = require("vega-lite/src/channel");
var config_1 = require("../../config");
var shorthand_1 = require("../../query/shorthand");
...
},{"../../config":1,"../../query/shorthand":16,"../../util":28,"./effectiveness":21,"./type":23,"vega-lite/src/channel":46}],21:[function(require,module,exports){
"use strict";
...
},{"./channel":20,"./mark":22}],22:[function(require,module,exports){
"use strict";
var channel_1 = require("vega-lite/src/channel");
var mark_1 = require("vega-lite/src/mark");
var util_1 = require("../../util");
...
},{"../../util":28,"./effectiveness":21,"./type":23,"vega-lite/src/channel":46,"vega-lite/src/mark":52}],23:[function(require,module,exports){
"use strict";
var scale_1 = require("vega-lite/src/scale");
var type_1 = require("vega-lite/src/type");
var encoding_1 = require("../../query/encoding");
...
},{"../../query/encoding":13,"vega-lite/src/scale":53,"vega-lite/src/type":57}],24:[function(require,module,exports){
"use strict";
...
},{"./aggregation":19,"./effectiveness/effectiveness":21,"./fieldorder":24}],26:[function(require,module,exports){
"use strict";
var type_1 = require("vega-lite/src/type");
...
},{"./config":1,"./util":28,"datalib/src/bins/bins":33,"datalib/src/import/type":35,"datalib/src/stats":36,"vega-lite/src/bin":45,"vega-lite/src/timeunit":56,"vega-lite/src/type":57}],27:[function(require,module,exports){
"use strict";
...
function xAxisOnTopForHighYCardinalityWithoutColumn(specM, schema, encQIndex, opt) {
    ...
    if (encQIndex[channel_1.Channel.COLUMN] === undefined) {
        var xEncQ = encQIndex[channel_1.Channel.X];
        var yEncQ = encQIndex[channel_1.Channel.Y];
        if (yEncQ !== undefined && yEncQ.field && scale_1.hasDiscreteDomain(encoding_1.scaleType(yEncQ))) {
            if (xEncQ !== undefined) {
...
},{"./query/encoding":13,"vega-lite/src/axis":44,"vega-lite/src/channel":46,"vega-lite/src/scale":53,"vega-lite/src/type":57}],28:[function(require,module,exports){
"use strict";
var util_1 = require("datalib/src/util");
...
},{"datalib/src/util":38}],29:[function(require,module,exports){
"use strict";
var property_1 = require("./property");
var util_1 = require("./util");
var aggregate_1 = require("vega-lite/src/aggregate");
...
exports.DEFAULT_NAME = {
    ...
    scaleProps: initNestedPropName(property_1.SCALE_CHILD_PROPS),
    axisProps: initNestedPropName(property_1.AXIS_CHILD_PROPS),
    legendProps: initNestedPropName(property_1.LEGEND_CHILD_PROPS)
};
...
var DEFAULT_SORT_PROPS = {
    field: [undefined],
    op: [aggregate_1.AggregateOp.MIN, aggregate_1.AggregateOp.MEAN],
    order: [sort_1.SortOrder.ASCENDING, sort_1.SortOrder.DESCENDING]
};
...
exports.DEFAULT_ENUM_INDEX = {
    ...
    aggregate: [undefined, aggregate_1.AggregateOp.MEAN],
    ...
    sort: [sort_1.SortOrder.ASCENDING, sort_1.SortOrder.DESCENDING],
    scale: [true],
...
},{"./property":11,"./util":28,"vega-lite/src/aggregate":43,"vega-lite/src/channel":46,"vega-lite/src/mark":52,"vega-lite/src/scale":53,"vega-lite/src/sort":54,"vega-lite/src/timeunit":56,"vega-lite/src/type":57}],30:[function(require,module,exports){
"use strict";
var property_1 = require("./property");
var propindex_1 = require("./propindex");
...
},{"./property":11,"./propindex":12}],31:[function(require,module,exports){
...
},{"../time":37,"../util":38}],34:[function(require,module,exports){
var util = require('./util'),
    gen = module.exports;
...
},{"./generate":34,"./import/type":35,"./util":38}],37:[function(require,module,exports){
...
},{"d3-time":32}],38:[function(require,module,exports){
(function (Buffer){
...
},{"./scale":53,"./util":58}],47:[function(require,module,exports){
"use strict";
var log = require("../../log");
var channel_1 = require("../../channel");
var scale_1 = require("../../scale");
...
},{"../../channel":46,"../../log":51,"../../scale":53,"../../util":58}],48:[function(require,module,exports){
...
},{"./log":51,"./util":58}],49:[function(require,module,exports){
"use strict";
...
},{"./channel":46,"./fielddef":50,"./util":58}],50:[function(require,module,exports){
...
},{"./aggregate":43,"./channel":46,"./log":51,"./type":57,"./util":58}],51:[function(require,module,exports){
...
},{"./channel":46,"vega-util":59}],52:[function(require,module,exports){
"use strict";
var util_1 = require("./util");
var Mark;
(function (Mark) {
...
},{"./util":58}],53:[function(require,module,exports){
"use strict";
var log = require("./log");
var util_1 = require("./util");
var ScaleType;
...
},{"./log":51,"./util":58}],54:[function(require,module,exports){
"use strict";
var SortOrder;
(function (SortOrder) {
...
},{"./aggregate":43,"./channel":46,"./encoding":49,"./fielddef":50,"./log":51,"./mark":52,"./scale":53,"./util":58}],56:[function(require,module,exports){
"use strict";
...
},{"./datetime":48,"./log":51,"./util":58}],57:[function(require,module,exports){
...
},{"json-stable-stringify":39,"vega-util":59}],59:[function(require,module,exports){
(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports) :
